...
def optimize_resume_for_job(
    ...
    #
    # Used by ATS scoring and for AI-readable resume content.
    # ---------------------------------------------------------
    ...
    #
    # IMPORTANT:
    # This contains database IDs for experience/projects.
    #
    # AI needs these IDs so it can create:
    #
    # target_id = actual database record ID
    #
    ...
    # Calculate ATS score
    #
    # Existing ATS scoring logic remains unchanged.
    # ---------------------------------------------------------
    ...
    # AI optimization
    #
    # generation_context is passed so AI can create concrete
    # reviewable AIChange objects with real target IDs.
    #
    # Example:
    #
    # {
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=(
                "AI optimization service is temporarily unavailable"
            ),
        )
...
def optimize_resume_section(
    ...
    # ---------------------------------------------------------
    # Structured context for section-level AI changes.
    #
    # This allows the AI service to resolve actual experience
    # and project IDs when producing AIChange objects.
    # ---------------------------------------------------------
